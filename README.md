...
# Многомерные массивы
Задача: найти максимальный элемент в строке.
```C++
...
{
	setlocale(LC_ALL, "ru");
	// задача - найти масксимальный элемент в текущей строке.
	srand(time(NULL));
	// задаем размерность массива
	const int rows = 3;
	const int cols = 3;

	int A[rows][cols]; // объявление двумерного статического массива

	// во внешнем цикле перебор отдельных строк
	for (int i = 0; i < rows; i++)
	{
		// во внутреннем цикле перебор отдельных столбцов
	...
	for (int i = 0; i < rows; i++)
	{
		...
		cout << "Максимальный элемент в " << i << " строке = " << max << endl;
	}
}
```
Задача: найти максимальный элемент в столбце.
```C++
// в этом файле содержатся rand и srand
#include<stdlib.h>
#include<time.h> 
...
{
	setlocale(LC_ALL, "ru");
	// задача - найти масксимальный элемент в текущем столбце
	srand(time(NULL));
	// задаем размерность массива
	const int rows = 3;
	const int cols = 3;
	...
	// поиск в столбцах максимального элемента
	// во внешнем цикле перебор столбцов!
	...
	for (int i = 0; i < cols; i++)
	{
		...
		cout << "Максимальный элемент в " << i << " столбце = " << max << endl;
	}
